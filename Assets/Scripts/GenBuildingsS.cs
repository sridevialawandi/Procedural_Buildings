...
public class GenBuildingsS: MonoBehaviour
{
    public float RandomSeed=8;
    private int MinimunComponents = 3;
    private int MaximumComponents = 15;
    ...
    void Start()
    {
        Ground=Resources.LoadAll<GameObject>("SGrounds");
        Floors=Resources.LoadAll<GameObject>("SFloor");
        Roof=Resources.LoadAll<GameObject>("SRoofs");
        StartBuild();
    }
    void StartBuild()
    {
