...
public class GenBuildingsL: MonoBehaviour
{
    public float RandomSeed=7;
    private int MinimunComponents = 3;
    private int MaximumComponents = 12;
    ...
    void Start()
    {
        Ground=Resources.LoadAll<GameObject>("LGrounds");
        Floors=Resources.LoadAll<GameObject>("LFloor");
        Roof=Resources.LoadAll<GameObject>("LRoofs");
        StartBuild();
    }
    void StartBuild()
    {
